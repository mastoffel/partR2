...
test_that("Poisson models with increasing complexity do not throw errors", {
    # pe
    expect_equal(r2_mod1_1$R2$R2, 0.103, tolerance = 0.01)
    # ci
    expect_equal(r2_mod1_2$R2$CI_lower, 0.0721, tolerance = 0.01)
    expect_equal(r2_mod1_2$R2$CI_upper, 0.162, tolerance = 0.01)
    # R2 one partvar
    expect_equal(r2_mod1_3$R2$R2, c(0.103, 0.099), tolerance = 0.01)
    # R2 two partvars
    expect_equal(r2_mod1_4$R2$R2, c(0.103, 0.099, 0.003, 0.103),
                 tolerance = 0.01)
