...
in itself and particularly useful in the case of multicollinearity. 

In addition to partial R2's the partR2 package calculates structure coefficients (SC).
...
the model estimates (slopes and variances). 
