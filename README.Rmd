...
which show the correlation between a fixed effect and the predicted response $\hat{Y}$,
...
the model estimates (slopes and variances). All calculations are embedded in
a parametric bootstrapping framework which allows to estimate confidence intervals
and which can be run in parallel. 
