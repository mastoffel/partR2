...
The main effects of the different predictors do not seem to explain very much! Maybe we should look at the combined main effects and interaction which is specified with the `*` in a lme4 formula. 
...
So it seems that most variance in biomass is explained by the "Temperature*Precipitation" effect, which includes both main effects and the interaction.
