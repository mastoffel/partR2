...
* Structure coefficients (SC), i.e. the correlation between each predictor and the fitted response (the contribution of a predictor to the model when ignoring all other predictors) (see Yeatts et al., 2017)
